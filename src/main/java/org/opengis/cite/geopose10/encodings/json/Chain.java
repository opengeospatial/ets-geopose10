...
public class Chain extends CommonFixture {
	...
	public void obtainTestSubject(ITestContext testContext) {
		...
		Object obj = testContext.getSuite().getAttribute(SuiteAttribute.CHAIN_TEST_SUBJ_FILE.getName());
	 ...
	 * JSON data against the GeoPose Chain JSON-Schema 2019-9 definition
	 */
